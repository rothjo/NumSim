 ...
 */
class Multigrid : public ParallelPressureSolver {
public:
    /**
     ...
     * @param partitioning Partitioning of the domain for parallel processing.
     */
...
private:
    ...
    std::vector<std::shared_ptr<ParallelCG>> smoothers_; ///< Smoothers for each level.
